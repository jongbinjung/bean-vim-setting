...
if	s:MSWIN
  " ==========  MS Windows  ======================================================
	...
	if match( s:sourced_script_file, escape( s:vimfiles, ' \' ) ) == 0
		...
		let s:plugin_dir						= $HOME.'/Dropbox/vim/bundle/cvim/'
		...
		let s:plugin_dir  					= $HOME.'/Dropbox/vimfiles/'
	endif
	"
	let s:C_LocalTemplateFile     = $HOME.'/Dropbox/vimfiles/c-support/templates/Templates'
	let s:C_LocalTemplateDir      = fnamemodify( s:C_LocalTemplateFile, ":p:h" ).'/'
	let s:C_CodeSnippets  				= $HOME.'/Dropbox/vimfiles/c-support/codesnippets/'
  ...
  " ==========  Linux/Unix  ======================================================
	...
	"
	let s:C_LocalTemplateFile     = $HOME.'/Dropbox/vim/bundle/cvim/c-support/templates/Templates'
	let s:C_LocalTemplateDir      = fnamemodify( s:C_LocalTemplateFile, ":p:h" ).'/'
	let s:C_CodeSnippets  				= $HOME.'/Dropbox/vim/bundle/cvim/c-support/codesnippets/'
